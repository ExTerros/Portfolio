...
const Home = () => {
  ...
  return (
    ...
    <div className="flex flex-col items-center justify-center min-h-screen relative">
      ...
      <p className="mb-6 text-lg font-normal text-gray-800 lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400 text-center">Développeur full stack en formation chez Zone01 Rouen</p>
      <p 
